        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const { data, errors } = yield commons_1.default.GQLRequest({
                    variables: { key, value },
                    query: mutations_1.default.UpdatePermission
                });
                ...
                return commons_1.default.Response(res, true, 'Update permission successfully!', null);
            }
            catch (error) {
...
exports.default = UpdatePermission;
